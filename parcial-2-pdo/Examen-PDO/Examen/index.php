...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    $idProducto = !empty($_POST['id']) ? $_POST['id'] : null;
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center">No se encontraron resultados para "<strong><?php echo htmlspecialchars($terminoBusqueda); ?></strong>"</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
