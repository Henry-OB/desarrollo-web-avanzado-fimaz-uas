...
Clonar el repositorio en la carpeta htdocs de tu servidor local (XAMPP).

Asegurarse de que el servidor Apache esté activo.Abrir el navegador y dirigirse a la siguiente ruta:
